...
export default function page() {
  ...
  <div className="contact">
    <div className="other">
      <div className="info">
        <h2>Group 3 - Trao tri thức, nhận niềm tin!</h2>
        <a className="btn-home" href="/pages/user/home">
    ...
    <div className="form">
      ...
      <div className="formRivew">
        ...
        <span id="fixEmail">! Vui lòng nhập Email</span>
        <div className="flex-rev">
          <textarea
        ...
        <span id="fixMessage">! Vui lòng nhập đánh giá</span>
        <button id="SubmitBtn" style={{ width: "100%" }}>
          Gửi
        </button>
      </div>
    </div>
